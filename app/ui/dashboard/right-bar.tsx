    ...
    <div>
      <div className='relative bg-card p-5 rounded-lg mb-5'>
        ...
        <div className='flex flex-col gap-6'>
          ...
          <h3 className='font-medium text-xs text-soft '>How to use the new version of the admin dashboard ?</h3>
      ...
      <div className='relative bg-card p-5 rounded-lg mb-5'>
        <div className='flex flex-col gap-6'>
          ...
          <h3 className='font-medium text-xs text-soft '>New server actions are available, partial pre-rendering is coming up !</h3>
